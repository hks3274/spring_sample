  ...
  <form method="post">
  	<table class="table table-bordered">
  	  ...
  	  <tr>
  	    <th>성별</th>
  	    <td>
  	      <input type="radio" name="strGender" id="gender1" class="mr-1" value="남자" ${strGender == '남자' ? 'checked' : ''} />남자 &nbsp;
  	      <input type="radio" name="strGender" id="gender2" class="mr-1" value="여자" ${strGender == '여자' ? 'checked' : ''} />여자
  	    </td>
  	  </tr>
  	  <tr>
